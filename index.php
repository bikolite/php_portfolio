  ...
  <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Sojib Ahmed</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#loginsignup">Login/Signup</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div id="main-slide" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img class="img-responsive" src="./assets/frontend/images/header-bg-1.jpg" alt="slider">
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated3">
                                <span><strong>Services</strong> for the highest</span>
                            </h1>
                ...
                <div class="item">
                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated1">
                    		  <span>Welcome to <strong>My Space</strong></span>
                    	    </h1>
                        ...
                        <div class="col-md-12">
                            <div class="pricing-table">
                                ...
                                <div class="plan-signup">
                                    <a href="#" class="btn-system btn-small">Buy Now</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="latest-news">
                    <div class="col-md-12">
                        <div class="latest-post">
                            ...
                            <div class="post-details">
                                <span class="date"><strong>31</strong> <br>Dec , 2023</span>
                    ...
                    <div class="col-md-12">
                        <div class="latest-post">
                            ...
                            <h4><a href="#">Standard Post with Image</a></h4>
                            <div class="post-details">
                                <span class="date"><strong>17</strong> <br>Feb , 2023</span>
                    ...
                    <div class="col-md-12">
                        <div class="latest-post">
                            ...
                            <h4><a href="#">Standard Post with Image</a></h4>
                            <div class="post-details">
                                <span class="date"><strong>08</strong> <br>Aug , 2023</span>
